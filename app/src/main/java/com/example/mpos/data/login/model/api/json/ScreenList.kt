...
data class ScreenList(
    ...
    @SerializedName("FreezePaymentwindow") val FreezePaymentwindow: Boolean,
    @SerializedName("EnableCustDetail") val enableCustDetail: Boolean,
    @SerializedName("screenlist") val screenList: String,
    @SerializedName("Stockcheck") val stockcheck: Boolean,
    @SerializedName("StockcheckUser") val stockcheckUser: String,
    @SerializedName("StockcheckURL") val stockcheckURL: String,
    @SerializedName("StockcheckPasscode") val stockcheckPasscode: String,
