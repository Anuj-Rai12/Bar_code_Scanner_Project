...
data class ConfirmBillingRequest @JvmOverloads constructor(
    @field:Element(name = "ConfirmBilling", required = false)
    @param:Element(name = "ConfirmBilling", required = false)
    @field:Path("Body")
    @param:Path("Body")
    val body: ConfirmBillingRequestBody? = null,
...
@Root(name = "ConfirmBilling", strict = false)
data class ConfirmBillingRequestBody @JvmOverloads constructor(
    @field:Attribute(name = "xmlns")
    @param:Attribute(name = "xmlns")
